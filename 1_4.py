...
KNOWN_COMMANDS = ["ls", "cd", "exit", "vfs-info", "cat", "pwd", "tail", "head", "uniq"]
...
class VFS:
    ...
    def list_directory(self, path=None, show_all=False):
    ...
    def read_file(self, filename, lines_limit=None):
        ...
        if filename.startswith('/'):
            ...
            file_path = (self.current_path.lstrip('/') + filename).lstrip('/')
            ...
            with self.zip_file.open(file_path) as f:
                ...
                try:
                    ...
                    if lines_limit is not None:
                        ...
                        limited_lines = lines[:lines_limit] if lines_limit > 0 else lines[lines_limit:]
                        text_content = '\n'.join(limited_lines)
    ...
    def file_exists(self, filename):
        ...
        return file_path in self.zip_file.namelist()
...
class VFSEmulator:
    ...
    def execute_command_directly(self, command_str):
        ...
        if command not in KNOWN_COMMANDS:
            ...
            items = self.vfs.list_directory(path, show_all)
